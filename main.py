...
from Roller485.unit_roller485_protocol import UnitRoller485Protocol as Prot
...
class Roller485Util(rs.RS485):
    ...
    @classmethod
    def replace_crc8(cls, prot: Prot) -> None:
        """CRC8を計算しパケットの末尾に代入

        Args:
            prot (Prot): CRC8を計算する対象のプロトコルオブジェクト
        """
    ...
    def _setting(
        self, command: Prot.CommandCode, data1: int, data2: int = 0, data3: int = 0
    ) -> None:
        """設定コマンドを送信

        Args:
            command (Prot.CommandCode): 設定するコマンド
            data1 (int): データ1
        ...
        payload = Prot.ConfigPayload(None, prot, prot._root)
        payload.data1 = data1
        payload.data2 = data2
        payload.data3 = data3
        payload._check()
    ...
    def _setting_resp(
        self, command: Prot.CommandCode, data1: int = 0, data2: int = 0, data3: int = 0
    ) -> bool:
        """設定コマンドのレスポンスを確認

        Args:
            command (Prot.CommandCode): 設定したコマンド
        ...
        resp = Prot(KaitaiStream(io.BytesIO(msg)))
        resp._read()
    ...
    def motor_switch(self, state: Switch) -> bool:
        ...
        """
        self._setting(Prot.CommandCode.motor_switch, data1=state.value)
        self._delay()
        return self._setting_resp(Prot.CommandCode.motor_switch_resp, data1=state.value)
    ...
    def mode_setting(self, mode: MotorMode) -> None:
        ...
        """
        self._setting(Prot.CommandCode.mode_setting, data1=mode.value)
        self._delay()
        return self._setting_resp(Prot.CommandCode.mode_setting_resp, data1=mode.value)
    ...
    def remove_protection(self, status: int) -> None:
        ...
        self._setting(Prot.CommandCode.remove_protection, data2=status)
        self._delay()
        return self._setting_resp(Prot.CommandCode.remove_protection_resp, data2=status)

    def save_to_flash(self) -> None:
        """フラッシュメモリに保存"""
        self._setting(Prot.CommandCode.save_to_flash, data1=1)
        self._delay()
        return self._setting_resp(Prot.CommandCode.save_to_flash_resp, data1=1)
    ...
    def set_encoder(self, value: int) -> None:
        ...
        Args:
            value (int): エンコーダの値
        """
        self._setting(Prot.CommandCode.encoder, data1=value)
        self._delay()
        return self._setting_resp(Prot.CommandCode.encoder_resp, data1=value)
    ...
    def button_switching_mode(self, mode: ButtonMode) -> None:
        ...
        """
        self._setting(Prot.CommandCode.button_switch_mode, data1=mode.value)
        self._delay()
        return self._setting_resp(
            Prot.CommandCode.button_switch_mode_resp, data1=mode.value
        )
    ...
    def rgb_led_control(
        ...
        data2 = brightness
        self._setting(Prot.CommandCode.rgb_led_control, data1=data1, data2=data2)
        self._delay()
        return self._setting_resp(
            Prot.CommandCode.rgb_led_control_resp, data1=data1, data2=data2
        )
    ...
    def set_rs485_baud_rate(self, baud_rate: RS485BaudRate) -> None:
        ...
        """
        self._setting(Prot.CommandCode.rs485_baud_rate, data1=baud_rate.value)
        self._delay()
        return self._setting_resp(
            Prot.CommandCode.rs485_baud_rate_resp, data1=baud_rate.value
        )
    ...
    def set_device_id(self, device_id: int) -> None:
        ...
        self._setting(Prot.CommandCode.device_id, data1=device_id)
        self._delay()
        return self._setting_resp(Prot.CommandCode.device_id_resp, data1=device_id)
    ...
    def set_motor_jam_protection(self, enable: bool) -> None:
        ...
        self._setting(Prot.CommandCode.motor_jam_protection, data1=enable)
        self._delay()
        return self._setting_resp(
            Prot.CommandCode.motor_jam_protection_resp, data1=enable
        )
    ...
    def set_motor_position_over_range_protection(self, enable: bool) -> None:
        ...
        enable = 1 if enable else 0
        self._setting(
            Prot.CommandCode.motor_position_over_range_protection, data1=enable
        )
        self._delay()
        return self._setting_resp(
            Prot.CommandCode.motor_position_over_range_protection_resp, data1=enable
        )
    ...
    def set_speed_and_max_current(self, speed: int, max_current: float) -> None:
        ...
        self._setting(
            Prot.CommandCode.speed_control, data1=speed, data2=max_current_int
        )
        self._delay()
        return self._setting_resp(
            Prot.CommandCode.speed_control_resp,
            data1=speed,
    ...
    def set_speed_pid(self, p: float, i: float, d: float) -> None:
        ...
        self._setting(
            Prot.CommandCode.speed_pid_config, data1=int_p, data2=int_i, data3=int_d
        )
        self._delay()
        return self._setting_resp(
            Prot.CommandCode.speed_pid_config_resp,
            data1=int_p,
            data2=int_i,
            data3=int_d,
        )
    ...
    def set_position_and_max_current(self, position: int, max_current: float) -> None:
        ...
        max_current_int: int = int(max(-1200, min(1200, max_current))) * 100
        self._setting(
            Prot.CommandCode.position_control,
            data1=position,
            data2=max_current_int,
        )
        self._delay()
        return self._setting_resp(
            Prot.CommandCode.position_control_resp,
            data1=position,
            data2=max_current_int,
        )
    ...
    def set_position_pid(self, p: float, i: float, d: float) -> None:
        ...
        int_d: int = int(d * 100_000)
        self._setting(
            Prot.CommandCode.position_pid_config, data1=int_p, data2=int_i, data3=int_d
        )
        self._delay()
        return self._setting_resp(
            Prot.CommandCode.position_pid_config_resp,
            data1=int_p,
            data2=int_i,
            data3=int_d,
        )
    ...
    def set_current(self, current: float) -> None:
        ...
        self._setting(Prot.CommandCode.current_control, data1=current_int)
        self._delay()
        return self._setting_resp(
            Prot.CommandCode.current_control_resp, data1=current_int
        )
...
def main():
    ...
    try:
        r485 = Roller485Util(
            target=TARGET, port=PORT, baudrate=BOUDRATE, timeout=TIMEOUT
        )
